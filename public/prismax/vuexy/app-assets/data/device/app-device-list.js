...
$(function () {
    ...
    if (dtUserTable.length) {
        dtUserTable.DataTable({
            ajax: {
                url: 'http://103.18.133.192:9001/device/list', // Ganti dengan URL API Anda
                dataSrc: 'data' // Menentukan sumber data dalam respons JSON
            },
            columns: [
                // columns according to JSON
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function (data, type, full, meta) {
                        ...
                        return "<span class='text-truncate align-middle'>" + $serial_number + '</span>';
                    }
                },
                {
                    targets: 3,
                    render: function (data, type, full, meta) {
                        ...
                        return '<span class="text-nowrap">' + $priority + '</span>';
                    }
                },
                {
                    // Actions
