        ...
        <div class="content-body">
            ...
            <section class="app-user-list">
                <!-- Select2 -->
                    <div class="col-12">
                        <div class="card mb-4">
                        <h5 class="card-header">Select Master For Detail</h5>
                        <div class="card-body">
                            <div class="row">
                            <!-- Basic -->
                            <div class="col-md-12 mb-4">
                                ...
                                <option value="AK">Master 1</option>
                                <option value="HI">Master 2</option>
                                <option value="CA">Master 3</option>
                                <option value="NV">Master 4</option>
                                </select>
                            </div>
